...
public class TowerBuilder : MonoBehaviour
{
    ...
    {
        return new Vector3(_buildPoint.position.x, currentSegment.position.y + currentSegment.localScale.y / 2 + _block.transform.localScale.y / 2 - 0.3f, _buildPoint.position.z);
    }
}
